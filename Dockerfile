...
# Build the project
RUN echo "Building project with REACT_APP_BACKEND_URL=$REACT_APP_BACKEND_URL, REACT_APP_REQUIRE_AUTH=$REACT_APP_REQUIRE_AUTH, and REACT_APP_AUTH_BACKEND_URL=$REACT_APP_AUTH_BACKEND_URL"
